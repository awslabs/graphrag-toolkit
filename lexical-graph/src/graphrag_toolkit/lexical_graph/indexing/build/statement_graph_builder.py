    ...
    def build(self, node:BaseNode, graph_client: GraphStore, **kwargs:Any):
        ...
        if statement_metadata:
            ...
            if statement:
                ...
                graph_client.execute_query_with_retry(query, self._to_params(properties), max_attempts=5, max_wait=7, operation=GraphQueryOperation.UPSERT_STATEMENT)
                ...
                if statement.chunkId:
                    ...
                    graph_client.execute_query_with_retry(query_c, self._to_params(properties_c), max_attempts=5, max_wait=7, operation=GraphQueryOperation.LINK_STATEMENT_CHUNK)
                ...
                if statement.topicId:
                    ...
                    graph_client.execute_query_with_retry(query_t, self._to_params(properties_t), max_attempts=5, max_wait=7, operation=GraphQueryOperation.LINK_STATEMENT_TOPIC)
                ...
                if prev_statement:
                    ...
                    graph_client.execute_query_with_retry(query_p, self._to_params(properties_p), max_attempts=5, max_wait=7, operation=GraphQueryOperation.LINK_STATEMENTS)
