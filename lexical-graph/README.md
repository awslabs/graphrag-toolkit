...
```
$ pip install graphrag-lexical-graph==3.18.7.dev0
```

Or install from a release zip file:

```
$ pip install https://github.com/awslabs/graphrag-toolkit/archive/refs/tags/graphrag-lexical-graph/v3.18.7.dev0.zip#subdirectory=lexical-graph
```
