...
```
$ pip install graphrag-lexical-graph==3.18.6
```

Or install from a release zip file:

```
$ pip install https://github.com/awslabs/graphrag-toolkit/archive/refs/tags/graphrag-lexical-graph/v3.18.6.zip#subdirectory=lexical-graph
```
