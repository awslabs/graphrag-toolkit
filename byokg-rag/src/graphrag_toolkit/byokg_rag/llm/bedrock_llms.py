...
class BedrockGenerator(BaseGenerator):
    ...
    """
    def __init__(self, model_name="anthropic.claude-sonnet-4-20250514-v1:0", region_name="us-west-2", prefill=False, max_tokens = 4096, max_retries = 10, inference_config=None, reasoning_config=None):
        """
