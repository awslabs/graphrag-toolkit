...
> **Note:** The statement index is approximately 10x larger than the chunk index and is associated with the deprecated semantic-guided retriever. It may be removed from the default configuration in a future release.
