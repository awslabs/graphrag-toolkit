...
## References
- [Base Classes](https://github.com/awslabs/graphrag-toolkit/tree/main/lexical-graph/src/graphrag_toolkit/lexical_graph/indexing/load/readers/)
- [Configuration Classes](https://github.com/awslabs/graphrag-toolkit/blob/main/lexical-graph/src/graphrag_toolkit/lexical_graph/indexing/load/readers/reader_provider_config.py)
- [Provider Implementations](https://github.com/awslabs/graphrag-toolkit/tree/main/lexical-graph/src/graphrag_toolkit/lexical_graph/indexing/load/readers/providers/)
